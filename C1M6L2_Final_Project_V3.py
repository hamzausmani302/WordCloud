...
def calculate_frequencies(file_contents):
    ...
    file_content = file_contents.replace('\r' , '');
    file_content = file_contents.replace('\n' , '');
    ...
    for i in range(0,len(content)):
        ...
        if(content[i].isalpha()):
            ...
            if content[i].lower() not in result.keys():
                result[content[i].lower()] = 0;
            result[content[i].lower()] += 1;
